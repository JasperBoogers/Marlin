...
#define CUSTOM_MACHINE_NAME "CR-20 Pro E3"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  26.72,  21.73 }
    #define DEFAULT_Ki_LIST {   2.30,   1.54 }
    #define DEFAULT_Kd_LIST {  77.48,  76.55 }
  #else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 103.75
  #define DEFAULT_bedKi 19.35
  #define DEFAULT_bedKd 370.89
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-45, -16, -0.88} // stock values before HMG6 upgrade: { -43, -5, 0 } 
...
#define X_MIN_POS 0
#define Y_MIN_POS -13 // stock value before HMG6 upgrade: 0
#define Z_MIN_POS 0
